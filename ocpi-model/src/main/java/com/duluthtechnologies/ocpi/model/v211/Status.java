...
/**
 * Status of the EVSE/Connector according to the OCPI 2.1.1 standard.
 */
public enum Status {
	...
	/**
	 * The EVSE/Connector is not accessible because of a physical barrier, i.e. a
	 * car.
	 */
	BLOCKED,
	...
	/**
	 * The EVSE/Connector is reserved for a particular EV driver and is unavailable
	 * for other drivers.
	 */
	RESERVED,
